 ...
 *
 * O endereço é do domínio e chega por Email Routing da Cloudflare, encaminhando
 * para a caixa privacidade.diadepagar@gmail.com. Se o encaminhamento cair, o
 * canal exigido pela LGPD cai junto.
 */
